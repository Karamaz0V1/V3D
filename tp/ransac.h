...
void ransac_full(const std::vector<vpImagePoint> & p1, const std::vector<vpImagePoint> & p2, std::vector<vpImagePoint> & p1_corrected, std::vector<vpImagePoint> & p2_corrected, int nb_try = 100, int nb_points_h = 5, float epsilon = 15);
